...
# Creates figures for paint factory example in LO Lecture 1, slides 19-24.
...
savefig("paint_factory_example_3.pdf")
...
savefig("paint_factory_example_4.pdf")
...
savefig("paint_factory_example_5.pdf")
...
savefig("paint_factory_example_6.pdf")
...
savefig("paint_factory_example_complete.pdf")
...
gif(anim, "paint_factory_example.gif", fps = 1)